...
describe('<ChartSummaryUsedByRunningQueries />', () => {
  ...
  it('renders chart with data', () => {
    cy.intercept('GET', '/api/v1/charts/summary-used-by-running-queries*', {
      ...
      body: {
        data: [
          {
            main: [{ query_count: 5, memory_usage: 1024000, readable_memory_usage: '1 MB' }],
  ...
  it('applies custom className', () => {
    cy.mount(
      <ChartSummaryUsedByRunningQueries {...defaultProps} className="custom-test-class" />
    )
  ...
  it('works with different hostId values', () => {
    cy.intercept('GET', '/api/v1/charts/summary-used-by-running-queries?hostId=1*', {
      statusCode: 200,
      body: {
        data: [
          {
            main: [{ query_count: 3, memory_usage: 512000, readable_memory_usage: '512 KB' }],
    ...
    cy.mount(<ChartSummaryUsedByRunningQueries hostId={1} title="Host 1 Summary" />)
