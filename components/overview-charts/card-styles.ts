...
export const cardStyles = {
  base: 'relative flex h-full flex-col justify-center overflow-hidden rounded-lg border border-border/60 bg-card/50 backdrop-blur-sm p-3 transition-all',
  ...
  divider: 'h-6 sm:h-8 w-px bg-border/60 shrink-0',
} as const
