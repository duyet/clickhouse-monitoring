...
export const GITHUB_URLS = {
  changelog: 'https://raw.githubusercontent.com/ClickHouse/ClickHouse/master/CHANGELOG.md',
  docsBase: 'https://raw.githubusercontent.com/ClickHouse/ClickHouse/master/docs/en/operations/system-tables',
} as const
 ...
 */
export const KNOWN_COLUMN_CHANGES: Record<string, Array<{
  table: string
  column: string
  type: string
  ...
  '24.1': [
    { table: 'system.query_log', column: 'query_cache_usage', type: 'Enum8', changeType: 'added' },
    { table: 'system.processes', column: 'peak_threads_usage', type: 'UInt64', changeType: 'added' },
  ],
  '23.8': [
