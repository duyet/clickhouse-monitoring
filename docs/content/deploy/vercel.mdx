...
Deploy the chmonitor Next.js app to Vercel. This targets the legacy `apps/dashboard` (Next.js) build. The current TanStack app (`apps/dashboard-tsr`) targets Cloudflare Workers; use [Cloudflare](/docs/deploy/cloudflare) for that.
