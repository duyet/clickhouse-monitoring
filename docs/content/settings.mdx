...
- [Feature Permissions](/docs/advanced/feature-permissions) — full reference for `CHM_FEATURE_*` env
- [Authentication](/docs/authentication) — setting up Clerk, Cloudflare Access, or proxy auth
- [AI Agent](/docs/ai-agent) — agent configuration and conversation store options
- [Install & Configure](/docs/deploy) — platform-specific deployment with all env vars
