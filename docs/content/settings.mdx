...
To change the active backend, set the relevant server-side env vars and redeploy. See [Conversation history backends](/ai-agent) in the AI Agent docs for the full env-var reference and setup steps.
