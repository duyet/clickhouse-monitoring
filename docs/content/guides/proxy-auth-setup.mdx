...
All three use chmonitor's `trusted` or `proxy` auth provider. See [Authentication](/authentication) for the full comparison.
...
- [Trusted proxy docs](/authentication/trusted-proxy)
- [Cloudflare Access docs](/authentication/cloudflare-access)
- [Trusted header docs](/authentication/trusted-header)
