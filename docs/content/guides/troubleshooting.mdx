...
One of `CHM_API_KEY_SECRET`, `CLERK_SECRET_KEY`, or `CHM_MCP_PUBLIC=true` must be set to open the endpoint. See [MCP Server — Permissions](/features/mcp#permissions--access).
</Callout>
