...
| `CONVERSATIONS_D1_DATABASE_ID` | — | Deploy-time Cloudflare D1 database UUID for the optional `CONVERSATIONS_D1` binding. Without it, deploy prep removes the unprovisioned binding unless D1 storage is explicitly required. |
