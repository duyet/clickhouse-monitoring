...
The variable names and values are identical — only the prefix differs. This page and the [Environment Variables](/docs/reference/environment-variables) reference use the `VITE_*` form. If you run the legacy Next.js app, substitute `NEXT_PUBLIC_` wherever you see `VITE_`.
...
LLM_MODEL=openrouter/free                    # default
```
