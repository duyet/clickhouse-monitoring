...
3. **`CHM_CONNECTIONS_ENCRYPTION_KEY`** — a 32-byte base64 key used to encrypt credentials at rest (AES-256-GCM).
...
# Docker / Kubernetes: pass CHM_CONNECTIONS_ENCRYPTION_KEY via -e or a Secret
```
</Step>
<Step>
