...
| **System tables** | Depends on the charts added; each chart queries its own system tables (see [Overview](/docs/features/overview), [Queries](/docs/features/queries), etc.) |
...
- [Queries](/docs/features/queries)
- [Operations](/docs/features/operations)
