...
Only if authentication is configured. The agent can query ClickHouse with the
same grants as the configured monitoring user. Require authenticated access for
agent, MCP, and action features on public deployments.
