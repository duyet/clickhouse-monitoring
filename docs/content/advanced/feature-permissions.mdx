...
> `VITE_*` vars are build-time inlined — set them before running `bun run build`. See [Migrate to v0.3](/docs/migrating/v0-3) if you are upgrading from the legacy Next.js app and need the old `NEXT_PUBLIC_*` names.
