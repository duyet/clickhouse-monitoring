...
**In-app settings UI** — chmonitor also has an application-level settings page where operators configure the dashboard itself (connection details, theme preferences, and feature toggles). See [Settings](/docs/settings) for that reference.
