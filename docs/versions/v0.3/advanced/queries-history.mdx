...
- The AI agent can analyze query history and surface patterns or anomalies — see [AI Agent](/docs/ai-agent).

---

## Related

- [Features — Queries](/docs/features/queries) — full overview of all query pages.
- [Environment Variables](/docs/reference/environment-variables) — `CLICKHOUSE_EXCLUDE_USER_DEFAULT` and connection settings.
- [Self-Tracking](/docs/advanced/self-tracking) — the dashboard's own event table.
