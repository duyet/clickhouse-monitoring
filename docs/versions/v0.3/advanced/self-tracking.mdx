...
- [Environment Variables — Query Execution](/docs/reference/environment-variables#query-execution) — `EVENTS_TABLE_NAME` and `CLICKHOUSE_DATABASE`.
- [Queries History](/docs/advanced/queries-history) — how the dashboard reads `system.query_log` for history pages.
