...
export const runningQueriesConfig: QueryConfig = {
  ...
  sql: [
    ...
    },
    {
      ...
      SELECT *,
        ...
        round(100 * memory_usage / max(memory_usage) OVER ()) AS pct_memory_usage,
        formatReadableQuantity(peak_threads_usage) as readable_peak_threads_usage,
  ...
  columnFormats: {
    ...
    readable_peak_threads_usage: ColumnFormat.BackgroundBar,
