 ...
 * @returns {string}
 */
export function transform_user_event_counts_json(input, time_field) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        wasm.transform_user_event_counts_json(retptr, ptr0, len0, ptr1, len1);
 ...
 * @returns {any}
 */
export function transform_user_event_counts_v3(input, time_field) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(time_field, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.transform_user_event_counts_v3(retptr, addHeapObject(input), ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('monitor_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
