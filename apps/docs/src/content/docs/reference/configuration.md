---
title: "Configuration"
editUrl: "https://github.com/duyet/clickhouse-monitoring/edit/main/docs/content/reference/configuration.mdx"
---
...
- [Environment Variables](/reference/environment-variables) — full list of every variable, grouped by category.
- [Feature Permissions](/advanced/feature-permissions) — config-file and env-override details.
- [Authentication](/authentication) — choose and configure an auth provider.
- [AI Agent — Configuration](/ai-agent/configuration) — LLM provider setup.
- [MCP Server](/reference/mcp-server) — connect external AI tools.
