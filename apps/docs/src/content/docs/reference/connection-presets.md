---
title: "Least-Privilege Connection Presets"
editUrl: "https://github.com/duyet/clickhouse-monitoring/edit/main/docs/content/reference/connection-presets.mdx"
---
...
### 3. Grant SELECT on system tables
...
> **Note on system table access in ClickHouse Cloud:** Some `system.*` tables are restricted at certain service tiers (e.g. `system.zookeeper` is not available on Serverless). See [Platform Support Matrix](/reference/support-matrix) for per-table availability across distributions and versions.
...
See [Environment Variables](/reference/environment-variables) for the full variable reference, and [Multiple Hosts](/advanced/multiple-hosts) for multi-host setup.
