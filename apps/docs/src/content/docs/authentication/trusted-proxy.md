...
editUrl: "https://github.com/duyet/clickhouse-monitoring/edit/main/docs/content/authentication/trusted-proxy.mdx"
---
...
| Cloudflare Access (signed JWT) | [`proxy` provider](/authentication/cloudflare-access) |
| nginx + a shared-secret header only (no full profile) | [`proxy` provider / trusted-header](/authentication/trusted-header) |
...
See [API keys](/authentication/api-keys).

## Related

- [Authentication overview](/authentication)
- [Cloudflare Access](/authentication/cloudflare-access)
- [Trusted header (proxy provider)](/authentication/trusted-header)
