---
title: "Settings"
editUrl: "https://github.com/duyet/clickhouse-monitoring/edit/main/docs/content/features/settings.mdx"
---
...
**In-app settings UI** — chmonitor also has an application-level settings page where operators configure the dashboard itself (connection details, theme preferences, and feature toggles). See [Settings](/settings) for that reference.
